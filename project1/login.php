                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 text-center">
                            <button type="button" class="btn btn-outline-success" omsubmit="validateEmail()">Submit</button>
                        </div>
                        <div class="col-md-4"></div>
                    </div>
                    <div class="row">
...
<script type="text/javascript">
    ...
    function validateEmail() {
        ...
        var reg = /^([A-Za-z0-9_\-\.])+\@([A-Za-z0-9_\-\.])+\.([A-Za-z]{2,4})$/; //  regex use is for email validation 
